...
<style scoped>
    .messageBox{background-color: white;z-index: 999 ;width: 200px; height: 140px; border: 1px #ccc solid; border-radius: 4px;box-shadow: 3px 3px 3px 3px #ccc;position: absolute;left: 50%;;top: 50%;margin: -60px 0 0 -100px;}
    .messageBox h2{ text-align: center; font-size: 18px; line-height: 40px;}
